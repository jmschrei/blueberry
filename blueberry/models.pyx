...
def Rambutan(**kwargs):
	...
	x2seq = Convolution(x2seq, 1, (7, 4), pad=(3, 0))
	x2seq = Pooling(x2seq, kernel=(3, 1), stride=(3, 1), pool_type='max')
	x2seq = Convolution(x2seq, 1, (7, 1), pad=(3, 0))
	x2seq = Pooling(x2seq, kernel=(3, 1), stride=(3, 1), pool_type='max')
